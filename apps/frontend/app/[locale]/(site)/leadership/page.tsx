...
export const metadata: Metadata = {
  ...
  description: "Découvrez l'équipe de direction de la Communauté des Eglises Camp de Jésus-Christ — des hommes et des femmes appelés par Dieu pour guider et servir.",
  openGraph: {
    title: "Leadership | C.E.C.J.",
